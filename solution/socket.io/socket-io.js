    ...
    const chat= io
        ...
        .on('connection', function (socket) {
            try {
                ...
                socket.on('KG', function (room, itemId, itemName, itemRc, itemGc, borderColor, row) {
                    // console.log('ssss')
                    socket.broadcast.to(room).emit('KG', room, itemId, itemName, itemRc, itemGc, borderColor, row);
                });
